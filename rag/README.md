...
Answers generated by this module are produced by Claude Opus 4.7 via the Anthropic API
and depend on the quality and completeness of the uploaded documents. AI-generated answers
may be inaccurate, incomplete, or misleading. Do not use them for medical, legal, financial,
or safety-critical decisions. All outputs should be reviewed before being relied upon.

Documents uploaded for embedding and questions submitted for answering are sent to the
Anthropic API. Review [Anthropic's Privacy Policy](https://www.anthropic.com/privacy) to
understand how that data is handled. Your `ANTHROPIC_API_KEY` is read from the environment
and is never stored by this module.
...
For usage terms and the full AI disclaimer, see [`../TERMS_OF_SERVICE.md`](../TERMS_OF_SERVICE.md).
